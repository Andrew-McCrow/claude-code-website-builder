---
description: Website design recreation workflow — follow this iterative loop when given a reference image
---
...
2. **Screenshot** the rendered page by running `node screenshot.js`. The screenshot is saved to `/tmp/current_screenshot.png`.
